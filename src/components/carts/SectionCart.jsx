...
const SectionCart = ({cartHeading ,cartcontent}) => {
  return (
         <div style={{
          ...
          "border-image-slice": "1",
         }} className='w-[384px]  ml-[15px] p-[32px] h-[300px] flex flex-col content-between justify-between border-2  bg-[#000000] border-transparent rounded-[12px]'>
              <div>
              ...
              <p className='w-[320px] h-[112px] font-[400] text-[18px] leading-[28px] text-[#EEF2F6] '>{cartcontent}</p>
            </div>
  )
}
